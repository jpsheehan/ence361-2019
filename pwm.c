...
static const int PWM_MAIN_PERIPH_PWM = SYSCTL_PERIPH_PWM0; //PWM module 0
static const int PWM_MAIN_PERIPH_GPIO = SYSCTL_PERIPH_GPIOC;
...
static const int PWM_TAIL_PERIPH_PWM = SYSCTL_PERIPH_PWM1; //PWM module 1
static const int PWM_TAIL_PERIPH_GPIO = SYSCTL_PERIPH_GPIOF;
